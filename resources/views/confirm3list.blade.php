...
@section('content')
    <div>
        ...
        <div class="container mt-5 ">
            <h1>Third Confirmation level</h1>
            <table class="table table-bordered table-sm" style="font-size: small">
                ...
                @foreach($requests as $request)
                    <tr style="color:black;text-align: center">
                        ...
                        <td><a  class="btn btn-primary" href={{"http://localhost:8000/confirm3/".$request['id_exit']}}>Confirm</a></td>
                        <td><a  class="btn btn-danger" href={{"http://localhost:8000/return3/".$request['id_exit']}}>Return</a></td>
                    </tr>
                @endforeach
