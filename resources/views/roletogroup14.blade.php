...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < response.results.length; i++) {
                        ...
                        mobile = $('<td hidden>' + response.results[i]['mobile'] + '</td>')
                        ...
                        t2.append(del2)
                        row = $('<tr></tr>')
                        row.append(id_user, f_name, l_name, email, name,id_request_part, t1, t2,mobile)
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        ...
                                        for (var i = 0; i < response.results.length; i++) {
                                            ...
                                            t2.append(del2)
                                            row = $('<tr></tr>')
                                            row.append(id_user, f_name, l_name, email, t1, t2,mobile)
                                            $("#user_table2").append(row)
                                        }
                                        toastr.options = {
                                            "closeButton": true,
                    ...
                    $(".edit1").on('click', function () {
                        ...
                        $('#mobile_edit').val($(this).closest('tr').find('td:eq(8)').text())
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            var t4 = ''
                            var row = ''
                            $("#request_table18").empty();
                            for(var i = 0; i < response.results.length; i++) {
                                edit1 = $('<button type="button" class="btn-sm btn-success edit" style="font-family: Tahoma;font-size: x-small;text-align: right" data-toggle="modal" data-target="#myModal8">ویرایش</button>').attr('id',response.results[i]['id_goods_type']+2000)
                                del2 = $('<button type="button" class="btn-sm btn-danger del" style="font-family: Tahoma;font-size: x-small;text-align: right">حذف</button>').attr('id',response.results[i]['id_goods_type']+3000)
                                id_goods_type = $('<td class="id_goods_type" style="width: 10%">' + response.results[i]['id_goods_type'] + '</td>')
                                description = $('<td style="width: 40%">' + response.results[i]['description'] + '</td>')
                                t1 = $('<td style="width: 10%"></td>')
                                t1.append(edit1)
                                t2 = $('<td style="width: 10%"></td>')
                                t2.append(del2)
                                row = $('<tr></tr>')
                                row.append(id_goods_type, description,t1,t2)
                                $("#request_table18").append(row)
                            }
                            $(".edit").on('click',function () {
                                $('#id_goods-type_edit').val($(this).closest('tr').find('td:eq(0)').text())
        ...
        $("#parts_form").on('submit', function (event) {
                ...
                success: function (response) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            var t4 = ''
                            var row = ''
                            $("#request_table19").empty();
                            for(var i = 0; i < response.results.length; i++) {
                                edit1 = $('<button type="button" class="btn-sm btn-success edit55" style="font-family: Tahoma;font-size: x-small;text-align: right" data-toggle="modal" data-target="#myModal9">ویرایش</button>').attr('id',response.results[i]['id_request_part']+2000)
                                del2 = $('<button type="button" class="btn-sm btn-danger del55" style="font-family: Tahoma;font-size: x-small;text-align: right">حذف</button>').attr('id',response.results[i]['id_request_part']+3000)
                                id_request_part = $('<td class="id_request_part" style="width: 10%">' + response.results[i]['id_request_part'] + '</td>')
                                description = $('<td style="width: 40%">' + response.results[i]['description'] + '</td>')
                                t1 = $('<td style="width: 10%"></td>')
                                t1.append(edit1)
                                t2 = $('<td style="width: 10%"></td>')
                                t2.append(del2)
                                row = $('<tr></tr>')
                                row.append(id_request_part, description,t1,t2)
                                $("#request_table19").append(row)
                            }
                            $(".edit55").on('click',function () {
                                alert('hi')
                                $('#id_request_part_edit2').val($(this).closest('tr').find('td:eq(0)').text())
                                $('#part_description_edit2').val($(this).closest('tr').find('td:eq(1)').text())
                            })
                            $(".del55").on('click',function () {
                                event.preventDefault();
                                var id_request_part = $(this).closest('tr').find('td:eq(0)').text();
                                var token = $("meta[name='csrf-token']").attr("content");
                                $.ajax({
                                    url: "/parts-delete/" + id_request_part,
                                    type: 'DELETE',
                                    data: {
                                        "id": id_request_part,
                                        "_token": token,
                                    ...
                                    success: function (response) {
                                        ...
                                        toastr.error('بخش درخواست کننده انتخاب شده حذف گردید');
                                        $('#' + (Number(id_request_part) + 3000)).closest('tr').remove();
                    ...
                    toastr.success("بخش درخواست کننده جدید با موفقیت ایجاد گردید", "", {
                        "timeOut": "3500",
                        "extendedTImeout": "0"
                    });
        ...
        $("#edit_form_goods").on('submit',function(event) {
            event.preventDefault();
            $.ajaxSetup({
                headers: {
                    'CSRF-TOKEN': $('meta[name="_token"]').attr('content')
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('.toast').toast('show');
                    $("#mytoast8").text("نوع قطعه انتخابی تغییر داده شد")
                    $.ajax({
                        url: '/goodstotal',
                        method:'GET',
                        success: function (response) {
                            ...
                            $(".edit").on('click',function () {
                                ...
                                $('#id_goods_type_edit').val($(this).closest('tr').find('td:eq(0)').text())
                                $('#description_edit').val($(this).closest('tr').find('td:eq(1)').text())
                            })
                            $(".del").on('click',function () {
                                event.preventDefault();
        ...
        $("#edit_form_parts").on('submit',function(event) {
            event.preventDefault();
            $.ajaxSetup({
                headers: {
                    'CSRF-TOKEN': $('meta[name="_token"]').attr('content')
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('.toast').toast('show');
                    $("#mytoast9").text("بخش درخواست کننده انتخابی تغییر داده شد")
                    $.ajax({
                        url: '/partstotal',
                        method:'GET',
                        success: function (response) {
                            ...
                            $("#request_table19").empty();
                            for(var i = 0; i < response.results.length; i++) {
                                edit1 = $('<button type="button" class="btn-sm btn-success edit33" style="font-family: Tahoma;font-size: x-small;text-align: right" data-toggle="modal" data-target="#myModal9">ویرایش</button>').attr('id',response.results[i]['id_request_part']+2000)
                                del2 = $('<button type="button" class="btn-sm btn-danger del33" style="font-family: Tahoma;font-size: x-small;text-align: right">حذف</button>').attr('id',response.results[i]['id_request_part']+3000)
                                id_request_part = $('<td class="id_request_part" style="width: 10%">' + response.results[i]['id_request_part'] + '</td>')
                                description = $('<td style="width: 40%">' + response.results[i]['description'] + '</td>')
                                t1 = $('<td style="width: 10%"></td>')
                                t1.append(edit1)
        ...
        $("#add_goods_type").on('click',function (event) {
            event.preventDefault();
            $(".addrole").hide()
            $(".usergroup").hide()
            $(".rolegroup").hide()
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(".del").on('click',function () {
                        event.preventDefault();
                        var id_goods_type = $(this).closest('tr').find('td:eq(0)').text();
                        var token = $("meta[name='csrf-token']").attr("content");
                        $.ajax({
                            url: "/goods-delete/" + id_goods_type,
                            type: 'DELETE',
                            data: {
                                "id": id_goods_type,
                                "_token": token,
                            ...
                            success: function (response) {
                                ...
                                toastr.error('نوع قطعه انتخاب شده حذف گردید');
                                $('#' + (Number(id_goods_type) + 3000)).closest('tr').remove();
        ...
        $("#add_parts_type").on('click',function (event) {
            event.preventDefault();
            $(".addrole").hide()
            $(".usergroup").hide()
            $(".rolegroup").hide()
            ...
            <div class="col-8  mt-3">
                <form method="post" encType="multipart/form-data" id="group_form" action={{route('group.store')}}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input type="text" maxlength="80" class="form-control gr_name" id="gr_name"  placeholder="نام گروه" name="gr_name" style="font-family: Tahoma;font-size: small;width:100% " required title="نام گروه را وارد کنید">
                        </div>
...
{{--                                        </tr>--}}
            ...
            <div class="col-8  mt-3">
                <form method="post" encType="multipart/form-data" id="role_form" action={{route('role.store')}}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input type="text" maxlength="80" class="form-control" id="role_latin"  placeholder="نام نقش به انگلیسی" name="role" required style="font-family: Tahoma;font-size: small;width:100%">
                        </div>
                        <div class="col-4" style="text-align: right">
                    ...
                    <div class="row mt-1">
                        <div class="col-8">
                            <input type="text" maxlength="80" class="form-control" id="role_farsi"  placeholder="نام نقش به فارسی" name="role_fa" required style="font-family: Tahoma;font-size: small;width:100%">
                        </div>
        ...
        <div class="row addgoods" style="display: none">
            <div class="col-2  mt-3">.</div>
            <div class="col-8  pegah pt-1" style="height: 30px;border-radius: 5px;margin-top: 50px"><p class="onvan">بخش تعیین نوع قطعات مورد نیاز</p></div>
            <div class="col-2  mt-3">.</div>
        </div>
        <div class="row addgoods" style="display: none">
            <div class="col-2  mt-3">.</div>
            <div class="col-8  mt-3">
                <form method="post" encType="multipart/form-data" id="goods_form" action={{route('goods.store')}}>
                    {{csrf_field()}}
                    <div class="row">
                        <div>
                            <input type="hidden" class="form-control" id="id_goods_type" name="id_goods_type" >
                        </div>
                        <div class="col-8">
                            <input type="text" maxlength="80" class="form-control description" id="description"  placeholder="نوع قطعه یا کالا" name="description" style="font-family: Tahoma;font-size: small;width:100% " required title="نوع قطعه را وارد کنید">
                        </div>
                        <div class="col-4" style="text-align: right">
                            <button type="submit" class="btn btn-success" id="btnupdate3" style="font-family: Tahoma;font-size: small;text-align: center;width:100%" >ثبت</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row mylist" style="margin: auto;width:100%;height:185px;direction: rtl;margin-top: 4px;border: 1px solid black;border-radius: 5px;background-color: beige">
                                <div class="col-12" style="direction: rtl;height: 183px;overflow-y: scroll">
                                    <table id="request_table18" align="center" style="width: 100%;font-family: Tahoma;font-size: small">
                                    </table>

                                </div>
                                <div class="toast bg-success" style="margin-top:20px;margin: auto;border-radius: 10px">
                                    <div class="toast-body"><p id="mytoast8" style="font-family: Tahoma;font-size: small;color: white;"></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row addparts" style="display: none">
            <div class="col-2  mt-3">.</div>
            <div class="col-8  pegah pt-1" style="height: 30px;border-radius: 5px;margin-top: 50px"><p class="onvan">بخش تعیین بخش درخواست کننده</p></div>
            <div class="col-2  mt-3">.</div>
        </div>
        <div class="row addparts" style="display: none">
            <div class="col-2  mt-3">.</div>
            <div class="col-8  mt-3">
                <form method="post" encType="multipart/form-data" id="parts_form" action={{route('parts.store')}}>
                    {{csrf_field()}}
                    <div class="row">
                        <div>
                            <input type="hidden" class="form-control" id="id_request_part" name="id_request_part" >
                        </div>
                        <div class="col-8">
                            <input type="text" maxlength="80" class="form-control description" id="description"  placeholder="بخش درخواست کننده" name="description" style="font-family: Tahoma;font-size: small;width:100% " required title="نوع قطعه را وارد کنید">
                        </div>
                        <div class="col-4" style="text-align: right">
                            <button type="submit" class="btn btn-success" id="btnupdate4" style="font-family: Tahoma;font-size: small;text-align: center;width:100%" >ثبت</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row mylist" style="margin: auto;width:100%;height:185px;direction: rtl;margin-top: 4px;border: 1px solid black;border-radius: 5px;background-color: beige">
                                <div class="col-12" style="direction: rtl;height: 183px;overflow-y: scroll">
                                    <table id="request_table19" align="center" style="width: 100%;font-family: Tahoma;font-size: small">
                                    </table>

                                </div>
                                <div class="toast bg-success" style="margin-top:20px;margin: auto;border-radius: 10px">
                                    <div class="toast-body"><p id="mytoast9" style="font-family: Tahoma;font-size: small;color: white;"></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-12">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="70" class="form-control" id="gr_name_edit"  name="gr_name" required style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
        ...
        <div class="modal fade mt-3" id="myModal8" style="direction: rtl;">
            <div class="modal-dialog modal-md" id="editlist" style="margin-top: 300px">
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-dark" style="height: 35px;padding-top: 5px;" >
                        <div class="row" style="width: 100%">
                            <div class="col-6"><p class="modal-title" style="color: white;font-family: Tahoma;font-size: small;display: inline">فرم اصلاح نوع قطعات</p></div>
                            <div class="col-6">
                                <div class="row" style="width: 100%">
                                    <div class="col-10">.</div>
                                    <div class="col-2">
                    ...
                    <!-- Edit form -->
                    <div class="container"  style="margin: auto;background-color:lightgray ">
                        <form method="post" encType="multipart/form-data" id="edit_form_goods" action="{{route('editform8.edit')}}">
                            {{csrf_field()}}
                            <input type="hidden" class="form-control" id="id_goods_type_edit"  name="id_goods_type">
                            <div class="row" style="height: 10px;margin-top: 25px;width: 100%">
                                <div class="col-12"><p style="text-align: right;font-family: Tahoma;font-size: small">نوع قطعه</p></div>
                            </div>
                            <div class="row" style="margin-top: 10px">
                                <div class="col-12">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="70" class="form-control" id="description_edit"  name="description" required style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col" style="margin-top: 20px">
                                    <button type="submit" class="btn btn-primary" id="btnupdate8" style="font-family: Tahoma;font-size: small;text-align: right">ذخیره</button>
                                </div>
                            </div>
        ...
        <div class="modal fade mt-3" id="myModal9" style="direction: rtl;">
            <div class="modal-dialog modal-md" id="editlist" style="margin-top: 300px">
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-dark" style="height: 35px;padding-top: 5px;" >
                        <div class="row" style="width: 100%">
                            <div class="col-6"><p class="modal-title" style="color: white;font-family: Tahoma;font-size: small;display: inline">فرم اصلاح بخش درخواست کننده</p></div>
                            <div class="col-6">
                                <div class="row" style="width: 100%">
                                    <div class="col-10">.</div>
                                    <div class="col-2">
                    ...
                    <!-- Edit form -->
                    <div class="container"  style="margin: auto;background-color:lightgray ">
                        <form method="post" encType="multipart/form-data" id="edit_form_parts" action="{{route('editform9.edit')}}">
                            {{csrf_field()}}
                            <input type="hidden" class="form-control" id="id_request_part_edit2"  name="id_request_part">
                            <div class="row" style="height: 10px;margin-top: 25px;width: 100%">
                                <div class="col-12"><p style="text-align: right;font-family: Tahoma;font-size: small">بخش درخواست کننده</p></div>
                            </div>
                            <div class="row" style="margin-top: 10px">
                                <div class="col-12">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="70" class="form-control" id="part_description_edit2"  name="description" required style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col" style="margin-top: 20px">
                                    <button type="submit" class="btn btn-primary" id="btnupdate9" style="font-family: Tahoma;font-size: small;text-align: right">ذخیره</button>
                                </div>
                            </div>
                    ...
                    <div class="container"  style="margin: auto;background-color:lightgray ">
                        <form method="post" encType="multipart/form-data" id="edit_form_role" action="{{route('editform2.edit')}}">
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-12">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="80" class="form-control" id="role_en_edit" required name="role" style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="height: 10px;margin-top: 25px;width: 100%">
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-12">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="80" class="form-control" id="role_fa_edit"  required name="role_fa" style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="container"  style="margin: auto;background-color:lightgray ">
                        <form method="post" encType="multipart/form-data" id="edit_form_user" action="{{route('editform3.edit')}}">
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-6">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="100" class="form-control" id="name_edit" required name="name" style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group" style="height: 15px">
                            ...
                            <div class="row" style="height: 10px;margin-top: 25px;width: 100%">
                                <div class="col-6"><p style="text-align: right;font-family: Tahoma;font-size: small">پست الکترونیکی:</p></div>
                                <div class="col-6"><p style="text-align: right;font-family: Tahoma;font-size: small">تلفن همراه:</p></div>
                            </div>
                            <div class="row" style="margin-top: 10px">
                                <div class="col-6">
                                    <div class="form-group" style="height: 15px">
                                        <input type="email" maxlength="100" class="form-control" id="email_edit" required name="email" style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="11" minlength="11" class="form-control" id="mobile_edit" required name="mobile" style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="height: 10px;margin-top: 25px;width: 100%">
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-6">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="100" class="form-control" id="f_name_edit" required name="f_name" style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group" style="height: 15px">
                                        <input type="text" maxlength="100" class="form-control" id="l_name_edit" required name="l_name" style="direction:rtl;font-family:Tahoma;font-size:small" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
