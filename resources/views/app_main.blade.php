        ...
        <div class="col-12">
            <div class="bg-dark" style="width: 100%;height:95px;margin-top: 3px;border-radius: 5px">
                ...
                <nav class="navbar navbar-expand mt-0 bg-info rounded col-12" style="height: 30px;direction: rtl">
                    <ul class="navbar-nav" >
                        <li class="nav-item">
                            <a class="nav-link" href="https://stnt.mapnaom-kz.com/index">صفحه اصلی</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="row" style="height: 150px;margin-top: 30px">
                ...
                <div class="col-12" style="border-radius: 5px;height: 90px;text-align: center">
                    <a href="https://stnt.mapnaom-kz.com/requester">
                    ...
                    <a href="https://stnt.mapnaom-kz.com/first-reciever">
        ...
        <div class="row" style="height: 500px;margin-top: 60px">
            <div class="col-12">
                <div class="container">
                    <h5 style="color: white;font-family: Tahoma;">کلیه درخواستهای یک ماه اخیر</h5>
                    <p style="color: white;font-family: Tahoma">این موارد در یک ماه گذشته جهت خروج از نیروگاه مجوز مدیریت نیروگاه را اخذ کرده اند</p>
