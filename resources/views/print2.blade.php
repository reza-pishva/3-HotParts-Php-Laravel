...
@section('content')
            <a href="{{url('/print2')}}" class="btnprn2 btn">
                <p><img src="https://stnt.mapnaom-kz.com/public/printer.png" style="width: 100px;height: 100px"></p>
            </a>
            <p class="title">لیست قطعات نیروگاهی و کالاهای در انتظار ورود</p>
