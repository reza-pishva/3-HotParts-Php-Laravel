            ...
            <div class="row mt-1" style="height:100%;margin: auto;width:100%">
                <div class="row mt-1" style="height:100%;margin: auto;width:233px">
                    <div class="col-10" style="border-radius: 5px;height: 500px;background-color:rgba(14,53,126,0.5);text-align: center">
                        <div class="bg-secondary" style="height: 60px;width: 100%;margin-top: 10px;border-radius: 3px;padding-top: 5px">
                        ...
                        <div>
                            <img src="{{URL::to('/')}}/herasat004.png" id="for_herasat" class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی را که هنوز از طرف مدیر حراست مورد بررسی قرار نگرفته اند مجددا به کارتابل موارد دریافتی برگردانید">
                        </div>
                        <div>
                        ...
                        <div>
                            <img  src="{{URL::to('/')}}/enter010.jpg"  id="from_herasat"  class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی که مورد تایید سرپرست حراست واقع نشده مشاهده کنید و در صورت تمایل به کارتابل موارد دریافتی بازگردانید">
                        </div>
