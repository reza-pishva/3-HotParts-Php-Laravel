...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="eKoktpSxxO3J64eqoi8qmYqhKnQjUpC4E5Rx1deA">
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < response.results.length; i++) {
                        if(response.results[i]['id_gr']==278){
                            admin_link = $('<li class="nav-item"><a id="admin" class="nav-link" href="/groupcreate">پنل مدیریت</a></li>');
                            break;
                        }
                        admin_link = $('<li class="nav-item"><a hidden id="admin" class="nav-link" href="/groupcreate">پنل مدیریت</a></li>');
                    }
...
<div class="container-fluid">
    ...
    <div class="container">
            ...
            <div class="col-10 mt-3">
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="16.jpg" class="carousel_img">
                        </div>
                    </div>
                            ...
                            <div class="container" >
                                <div class="row" >
                                    <div class="col-12" style="margin-top: 1px">
                                        <a href="/login">
                                            <img src="login001.png" class="reza4" data-toggle="tooltip" data-placement="right" title="ورود  login">
                                        </a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <a href="/user-reg">
                                            <img src="reg001.png" class="reza4" data-toggle="tooltip" data-placement="right" title="ثبت نام Register">
                                        </a>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a href="/undercons" data-toggle="modal" data-target="#myModal12">
                                            <img src="forget001.png" class="reza4" data-toggle="tooltip" data-placement="right" title="فراموشی رمز عبور">
                                        </a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <a href="/changepass">
                                            <img src="change_password.png" class="reza4" data-toggle="tooltip" data-placement="right" title="تغییر کلمه عبور">
                                        </a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <a href="/out">
                                            <img src="logout.png" class="reza4" data-toggle="tooltip" data-placement="right" title="logout">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row" style="margin-top: 30px">
            <div class="col-4">
                <div id="pro_desc_div">
                    <p id="pro_desc_text" style="font-family: reza;font-size: 16px">در این بخش کلیه نرم افزارهای مورد استفاده در نیروگاه کازرون بصورت متمرکز قابل دسترسی است. این نرم افزارها مواردی چون سیستم آمار و دفاتر گزارش بخشهای مختلف و نیز مدیریت اسناد و بسیاری از موارد مورد استفاده همکاران در امور مالی و اداری را پوشش می دهد.برای این نرم افزارها سطوح دسترسی متناسب با نیاز همکاران تعریف شده که توسط مدیر سیستم اعمال گردیده است</p>
                </div>
            </div>
            <div class="col-8">

                <div id="pro_title_div" class="bg-info" style="height: 30px;margin: auto" >

                    <p id="pro_title_text">نرم افزارهای مورد استفاده در نیروگاه</p>

                </div>
                <div style="background: rgba(171, 205, 239, 0.3);border-radius: 10px;margin-top: 2px;height:180px;margin: auto">
                    <div class="row ml-5" style="height:60px;margin-top:5px">
                        <div class="col-10" style="border-radius: 5px;height: 60px;text-align: center">
                            <div class="row">
                                <div class="col-1"></div>
                                <div class="col-2">
                                    <a href="/herasat2">
                                        <img src="person.jpg" class="reza10" data-toggle="tooltip" data-placement="bottom" title="نرم افزار مدیریت ورود و خروج افراد">
                                    </a>
                                </div>

                                <div class="col-2">
                                    <a href="https://bahrebardari.mapnaom-kz.com">
                                        <img src="notebook2.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="دفاتر گزارش روزانه">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="https://automation.mapnaom-kz.com">
                                        <img src="automation2.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="اتوماسیون اداری">
                                    </a>
                                </div>
                                ...
                                <div class="col-2">
                                    <a href="/herasat">
                                        <img src="cargo01.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="نرم افزار مدیریت ورود و خروج قطعات و کالا">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="https://rahkaran.mapnaom.com/OM3g/x47ad57c0/Authentication/Login.aspx?ReturnUrl=%2fOM3g%2fx47ad57c0%2f%3frnd%3d8d7c42c6e65d969">
                                        <img src="accounting.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="نرم افزارهای امور مالی">
                                    </a>
                                </div>
                    ...
                    <div class="row ml-5" style="height: 100px;margin-top: 30px">
                        <div class="col-10" style="border-radius: 5px;height: 60px;text-align: center">
                            <div class="row">
                                <div class="col-1"></div>
                                <div class="col-2" id="savabegh">
                                    <a href="/fsavabegh">
                                        <img src="doc_management.jpg" class="reza10" data-toggle="tooltip" data-placement="bottom" title="سوابق قطعات داغ">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="/reporti2">
                                ...
                                <div class="col-2">
                                    <a href="/report">
                                        <img src="lakshit.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="گزارش ورود و خروج کالا">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="http://172.28.232.27:8080/">
                                        <img src="hse.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="گزارش ورود و خروج افراد">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="/amar1">
                                        <img src="statistic001.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="سیستم آمار نیروگاه">
                                    </a>
        ...
        <div class="row bg-dark" style="margin-top: 5px;border-radius: 5px">
            <div class="col-7 bg-dark mt-2" style="text-align: right;height: 370px;border-radius: 5px;"><p id="pro_desc_text2" style="direction: rtl;color: white;margin-top: 23px;text-indent: 10px;line-height:1.7;font-family: reza;font-size: 16px"><img src="{{URL::to('/')}}/mapna04.jpg" style="width:370px;height:250px;margin-right:15px;float: left;margin-top: 5px;border-radius: 10px">گروه مپنا از آغاز بنیانگذاری در سال ۱۳۷۱، اجرای نزدیک به ۱۰۰ پروژه به ارزش بیش از ۳۰ میلیارد یورو را در کارنامهٔ خود ثبت نموده‌است. افزون بر آن ۶۰ محصول گوناگون و ۸۵ نوع خدمات مختلف را به مشتریان خود عرضه می‌کند.
            ...
            <div class="col-5 bg-dark mt-2" style="text-align: right;height: 370px;border-radius: 5px">
                <img src="mapna002.jpg" style="width:430px;height:350px;margin:auto;margin-top: 8px;border-radius: 10px">
            </div>
        </div>
    </div>

    <div class="row" style="margin: auto;border-radius: 5px;margin-top: 30px;background-color: black">
        <div class="col-3"></div>
        <div class="col-9">
            <div class="row">
                <div class="col">
    ...
    <div class="modal-dialog modal-md" id="passrecovery" style="margin-top: 300px">
        <div class="modal-content">
            ...
            <div class="container" id="reason_win" style="margin: auto;background-color:lightgray ">
                <form method="post" encType="multipart/form-data" id="recovery_form_request" action="{{URL::to('/')}}/recover">
                    <input type="hidden" name="_token" value="eKoktpSxxO3J64eqoi8qmYqhKnQjUpC4E5Rx1deA">
                    <div class="row">
                        <div class="col mt-2">
