...
<body style="margin:0;text-align: center;background-image: url('./p1.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;backdrop-filter: brightness(35%);">
        ...
        <div class="col-12" style="height: 100%">
            <div class="bg-dark" style="width: 100%;height:100%;margin-top: 3px;border-radius: 5px">
                <div class="row justify-content-center" style="height: 100%">
                    ...
                    <div class="col-2 pt-1"><img src="./herasat004.png" class="rounded-circle" style="width:30%;height:50%"><p style="color: white;text-align: center;font-family: Tahoma;font-size: small">{{$full_name}}</p></div>
                </div>
            </div>
        </div>
    </div>
...
{{--                       </div >--}}
                       <div class="col">
                           <img src="./total3.png" id="total" class="reza2" data-toggle="tooltip" data-placement="left" title="مشاهده کلیه درخواستها جهت اعمال تغییرات">
                       </div >
                       <div class="col">
                           <img src="./person_search002.png" id="present" class="reza2" data-toggle="tooltip" data-placement="left" title="مشاهده افراد حاضر در نیروگاه">
                       </div >
                       <div class="col">
                           <img src="./enter010.jpg" id="for_requester2" class="reza2" data-toggle="tooltip" data-placement="left" title="موارد تایید نشده توسط شما">
                       </div >
                       <div class="col">
                           <img src="./nono.jpg" id="for_requester" class="reza2" data-toggle="tooltip" data-placement="left" title="موارد تایید نشده توسط شما">
                       </div>
                       <div class="col">
                           <img src="./modir004.jpg" id="for_modir" class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی را که هنوز توسط مدیر نیروگاه مورد بررسی قرار نگرقته مجددا به کارتابل موارد دریافتی برگردانید">
                       </div>
                       <div class="col">
                           <img src="./sent.jpg" id="first_report" class="reza2" data-toggle="tooltip" data-placement="left" title="لیست درخواستهای مجوز ورود که از طرف امور حراست شده اند">
                       </div>
                   </div>
               </div>
               <div class="col-3"></div>
