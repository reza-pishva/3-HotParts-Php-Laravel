        ...
        <div class="col-12">
            <div class="bg-dark" style="width: 100%;height:95px;margin-top: 3px;border-radius: 5px">
                <div class="row justify-content-center" style="height: 100px">
                    ...
                    <div class="col-2 mt-3"><img src="./hse.png" class="rounded-circle" style="width: 30%;height: 50%"><p style="color: white;text-align: center;font-family: Tahoma;font-size: small">{{$full_name}}</p></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-2">
            <div class="row mt-1" style="height:100%;margin: auto;width:100%">
                    <div class="col-10" style="border-radius: 5px;height: 630px;background-color:rgba(14,53,126,0.5);text-align: center">
                        ...
                        <div>
                            <img src="./sent.jpg" id="first_report" class="reza2" data-toggle="tooltip" data-placement="left" title="لیست درخواستهای مجوز ورود که از طرف مدیر نیروگاه تایید شده اند">
                        </div>
                        <div>
                            <img src="./herasat004.png" id="second_report" class="reza2" data-toggle="tooltip" data-placement="left" title="لیست افرادی که در بازه زمانی مجاز برای ورود به نیروگاه قرار دارند">
                        </div>
                        <div>
