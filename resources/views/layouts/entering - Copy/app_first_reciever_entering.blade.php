        ...
        <div class="col-12">
            <div class="bg-dark" style="width: 100%;height:95px;margin-top: 3px;border-radius: 5px">
                <div class="row justify-content-center" style="height: 100px">
                    ...
                    <div class="col-2 mt-3"><img src="./modir001.png" class="rounded-circle" style="width: 30%;height: 50%"><p style="color: white;text-align: center;font-family: Tahoma;font-size: small">{{$full_name}}</p></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row mt-1" style="height:100%;margin: auto;width:100%">
                <div class="row mt-1" style="height:100%;margin: auto;width:233px">
                    <div class="col-10" style="border-radius: 5px;height: 660px;background-color:rgba(14,53,126,0.5);text-align: center">
                        ...
                        <div>
                            <img src="./sent.jpg" id="for_first_confirmation" class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی که جهت تایید برای شما ارسال شده اند ببینید">
                        </div>
                        <div>
                            <img src="./imeni002.png" id="for_herasat" class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی را که هنوز از طرف مسئول ایمنی مورد بررسی قرار نگرفته اند مجددا به کارتابل موارد دریافتی برگردانید">
                        </div>
                        <div>
                            <img src="./nono.jpg" id="for_requester" class="reza2" data-toggle="tooltip" data-placement="left" title="در اینجا می توانید مواردی که از طرف شما مورد تایید قرار نگرفته ببینید و در صورت تمایل به کارتابل موارد دریافتی بازگردانید">
                        </div>
                        <div>
                            <img  src="./enter010.jpg"  id="from_herasat"  class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی که مورد تایید مدیر نیروگاه واقع نشده مشاهده کنید و در صورت تمایل به کارتابل موارد دریافتی بازگردانید">
                        </div>
                        <div>
                            <img src="./total.jpg" id="total_part" class="reza2" data-toggle="tooltip" data-placement="left" title="کلیه درخواستهای ارسالی در این بخش">
                        </div>
