    ...
    <div class="row justify-content-center" style="width: 100%;margin: auto;height:700px">
        <div class="row" style="width: 100%;height: 200px">
            <div class="col-3" style="height: 190px">
                <img src="10.jpg" id="btn_tamirat" class="reza20">
            </div>
            <div class="col-3" style="height: 190px">
                <img src="index-20210125-151206-Ansaldo-Italy.jpg" id="btn_tamirat" class="reza20">
            </div>
            <div class="col-3" style="height: 190px">
                <img src="ansaldo-uae-resized.jpg" id="btn_tamirat" class="reza20">
            </div>
            <div class="col-3" style="height: 190px">
                ...
                <div style="height:25%;width: 80%;border-radius: 5px;background-color: #681200;margin-top: 5px;text-align: center;padding-top: 7px;margin-left: 30px">
                    <p style="font-family: reza;font-size: 20px;color: #d0d374;font-weight: bold">آنسالدو</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-8">
                <div class="row justify-content-center" style="width:100%;margin: auto;height:330px">
                    <div class="row" style="width: 110%">
                        <div class="col" style="border-radius: 5px;text-align: center;background-color: #228383">
                            <p style="font-family: reza;font-size: 15px;margin-top: 16px;color: white">فرمهای مربوط به تعریف برنامه</p>
                        </div>
                        <div class="col ml-2" style="border-radius: 5px;text-align: center;background-color: #228383">
                                    ...
                                    <div class="col" style="height:85px;">
                                        <div class="row" style="margin-top:-10px">
                                            <div class="col" style="text-align: center">
                                                <a href="/tapr-form">
                                                    <img src="Custom-Icon-Design-Pretty-Office-5-Maintenance.ico" id="btn_tamirat" class="reza2" data-toggle="tooltip" data-placement="bottom" title="تعمیرات دوره ای">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="row mt-2" style="width: 95%;margin-right: 5px">
                                    <div class="col" style="margin:auto;height:85px">
                                        <div class="row" style="margin-top:-10px">
                                            <div class="col" style="text-align: center">
                                                <a href="/tain-form">
                                                    <img src="stock_out-512.webp" id="btn_anbar" class="reza2" data-toggle="tooltip" data-placement="bottom" title=" ایجاد برنامه ورود و خروج از انبار">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="col" style="height:85px">
                                        <div class="row" style="margin-top:-10px">
                                            <div class="col" style="text-align: center">
                                                <a href="/buy-form">
                                                    <img src="Icons-Land-Transport-Lorry.ico" id="btn_buy" class="reza2" data-toggle="tooltip" data-placement="bottom" title=" ایجاد برنامه خرید">
                                                </a>
                                ...
                                <div class="row mt-3" style="width: 95%;margin-right: 5px">
                                    <div class="col" style="height:85px">
                                        <div class="row" style="margin-top:-10px">
                                            <div class="col" style="text-align: center">
                                                <a href="/out-form">
                                                    <img src="302331995792832846.png" id="btn_eex" class="reza2" data-toggle="tooltip" data-placement="bottom" title=" ایجاد برنامه ارسال قطعه">
                                                </a>
                                ...
                                <div class="row mt-1" style="width: 95%;margin-right: 5px">
                                    <div class="col" style="height:85px;">
                                        <div class="row" style="margin-top:-10px">
                                            <div class="col" style="text-align: center">
                                                <a href="/bazsaz-form">
                                                    <img src="Database 4.ico" id="btn_tamirat" class="reza2" data-toggle="tooltip" data-placement="bottom" title="اطلاعات پایه">
                                                </a>
                                    ...
                                    <div class="col" style="height:85px">
                                        <div class="row" style="margin-top:-10px">
                                            <div class="col" style="text-align: center">
                                                <a href="/group-form">
                                                    <img src="137738_document_256x256.png" id="btn_bazsazi" class="reza2" data-toggle="tooltip" data-placement="bottom" title="فرم ایجاد گروه">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
                            ...
                            <div class="row" style="margin-left: 35px">
                                <div class="row mt-1" style="width: 95%;margin-right: 5px">
                                    <div class="col" style="height:85px">
                                        <div class="row" style="margin-top:-10px">
                                            <div class="col" style="text-align: center">
                                                <a href="/savabegh-form">
                                                    <img src="Creative-Freedom-Shimmer-Document-Add.ico" id="btn_buy" class="reza2" data-toggle="tooltip" data-placement="bottom" title="ثبت سوابق">
                                                </a>
