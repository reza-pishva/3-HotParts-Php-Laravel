...
<style>
    ...
    body
    {
        margin:0;
        text-align: center;
        background-image: url('https://stnt.mapnaom-kz.com/public/bg001.jpg');
    ...
    <div class="container">
                 ...
                 <div id="demo" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="https://stnt.mapnaom-kz.com/public/14.jpg" class="carousel_img">
                            </div>
                            <div class="carousel-item">
                                <img src="https://stnt.mapnaom-kz.com/public/13.jpg"  class="carousel_img">
                            </div>
                            <div class="carousel-item">
                                <img src="https://stnt.mapnaom-kz.com/public/16.jpg" class="carousel_img">
                            </div>
                        </div>
        ...
        <div class="row" style="margin-top: 50px">
            ...
            <div class="col-8">
                ...
                <div id="pro_title_div" class="bg-info" style="height: 30px;padding-top: 1px">

                        <p id="pro_title_text">نرم افزارهای مورد استفاده در نیروگاه</p>

                </div>
                <div style="background: rgba(171, 205, 239, 0.3);border-radius: 10px;margin-top: 2px;height: 200px">
                  <div class="row" style="height: 80px;margin-top: 30px">
                    <div class="col-12" style="border-radius: 5px;height: 60px;text-align: center">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <a href="/herasat2">
                                        <img src="https://stnt.mapnaom-kz.com/public/person.jpg" class="reza10" data-toggle="tooltip" data-placement="bottom" title="نرم افزار مدیریت ورود و خروج افراد">
                                    </a>
                                </div>
                                ...
                                <div class="col-2">
                                    <a href="https://automation.mapnaom-kz.com">
                                        <img src="https://stnt.mapnaom-kz.com/public/automation2.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="اتوماسیون اداری">
                                    </a>
                                </div>
                                ...
                                <div class="col-2">
                                    <a href="/herasat">
                                        <img src="https://stnt.mapnaom-kz.com/public/cargo01.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="نرم افزار مدیریت ورود و خروج قطعات و کالا">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="https://rahkaran.mapnaom.com/OM3g/x47ad57c0/Authentication/Login.aspx?ReturnUrl=%2fOM3g%2fx47ad57c0%2f%3frnd%3d8d7c42c6e65d969">
                                        <img src="https://stnt.mapnaom-kz.com/public/accounting.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="نرم افزارهای امور مالی">
                                    </a>
                                </div>
                                <div class="col-1"></div>
                            </div>
                  ...
                  <div class="row" style="height: 100px;margin-top: 30px">
                    <div class="col-12" style="border-radius: 5px;height: 60px;text-align: center">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <a href="/undercons">
                                        <img src="https://stnt.mapnaom-kz.com/public/chemistry.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="سیستم آمارشیمی نیروگاه">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="/undercons">
                                        <img src="https://stnt.mapnaom-kz.com/public/quality.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="تضمین کیفیت">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="/report">
                                        <img src="https://stnt.mapnaom-kz.com/public/lakshit.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="گزارش ورود و خروج کالا">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="/reportp">
                                        <img src="https://stnt.mapnaom-kz.com/public/hse.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="گزارش ورود و خروج افراد">
                                    </a>
                                </div>
                                <div class="col-2">
                                    <a href="http://172.28.232.27:8000/amar1">
                                        <img src="https://stnt.mapnaom-kz.com/public/statistic001.png" class="reza10" data-toggle="tooltip" data-placement="bottom" title="سیستم آمار نیروگاه">
                                    </a>
        ...
        <div class="row bg-dark" style="margin-top: 50px;border-radius: 5px">
            ...
            <div class="col-5 bg-dark mt-2" style="text-align: right;height: 370px;border-radius: 5px">
                <img src="https://stnt.mapnaom-kz.com/public/mapna002.jpg" style="width:430px;height:350px;margin:auto;margin-top: 8px;border-radius: 10px">
            </div>
        </div>
    </div>
...
{{--<div class="modal fade" id="myModal13" style="direction: rtl;margin-top: 500px">--}}
