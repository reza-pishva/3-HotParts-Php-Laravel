...
<div class="container-fluid" id="reza">
    <div class="row justify-content-center" style="height: 80px">
        <div class="col-12">
            <div  style="width: 100%;height:95px;margin-top: 3px;border-radius: 5px;">
                <div class="row justify-content-center" style="height: 80px">
                    <div class="col-2"><img src="mapna.jpg" class="rounded-circle mt-1 ml-3" alt="Cinque Terre"></div>
                    <div class="col-1"></div>
                    <div class="col-1"></div>
                    <div class="col-1"></div>
                    <div class="col-5"><p style="color: white;text-align: right;margin-top: 10px;font-family: Tahoma;font-size: large;font-weight: bold">نیروگاه سیکل ترکیبی کازرون</p><p style="color: white;text-align: right;font-family: Tahoma;font-size: small;font-weight: bold">(MITSUBISHI) ورود اطلاعات مربوط به برنامه ریزی تعمیرات</p></div>
                    <div class="col-1"></div>
                    <div class="col-1"></div>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand bg-info rounded col-12" style="height: 30px;direction: rtl;margin-top: 1px;padding-top: 22px">
        <ul class="navbar-nav" >
            <li class="nav-item">
                <a class="nav-link" href="/m-bazsaz-form"><p style="font-family: Tahoma;font-size: small">ورود اطلاعات پایه</p></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/m-savabegh"><p style="font-family: Tahoma;font-size: small">بازگشت</p></a>
            </li>
