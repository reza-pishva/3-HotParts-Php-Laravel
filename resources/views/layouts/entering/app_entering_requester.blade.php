        ...
        <div class="col-2">
            <div class="row mt-1" style="height:100%;margin: auto;width:100%">
                    <div class="col-10" style="border-radius: 5px;height: 680px;background-color:rgba(14,53,126,0.5);text-align: center">
                        ...
                        <div>
                            <a href="/enteringform">
                                <img src="{{URL::to('/')}}/form.png" id="formcreate"  class="reza2" data-toggle="tooltip" data-placement="left" title="از این طریق می توانید فرم جدیدی برای درخواست مجوز ورود افراد به نیروگاه ایجاد کنید">
                            </a>
                        ...
                        <div>
                            <img src="{{URL::to('/')}}/edit.png" id="first_report" class="reza2" data-toggle="tooltip" data-placement="left" title="موارد ارسالی برای مسئول مستقیم.در اینجا می توانید مواردی را که هنوز مورد بررسی سرپرست قسمت قرار نگرفته اند تغییر داده و یا حذف کنید">
                        </div>
                        <div>
                            <img src="{{URL::to('/')}}/sent.jpg" id="second_report" class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی که توسط شما درخواست مجوز شده اند ببینید">
                        </div>
                        <div>
                            <img src="{{URL::to('/')}}/nono.jpg" id="third_report" class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید فرمهایی که جهت مجوز مورد تایید قرار نگرفته ببینید">
                        </div>
                        <div>
                            <img  src="{{URL::to('/')}}/permit02.png" id="fourth_report"  class="reza2" data-toggle="tooltip" data-placement="left" title="از اینجا می توانید مواردی که مجوز ورود به نیروگاه گرفته اند مشاهده کنید">
                        </div>
                        <div class="bg-secondary" style="height:40px;width: 100%;margin-top: 5px;border-radius: 3px;padding-top: 6px">
