...
<body style="margin:0;text-align: center;background-image: url('{{URL::to('/')}}/13.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;backdrop-filter: brightness(40%);">
        ...
        <div class="col-2">
            <div class="row mt-1" style="height:100%;margin: auto;width:100%">
                    <div class="col-10" style="border-radius: 5px;height: 100%;background-color:rgba(14,53,126,0.5);text-align: center">
                        ...
                        <div>
                            <img src="{{URL::to('/')}}/unauthorised002.jpg" id="third_report" class="reza2" data-toggle="tooltip" data-placement="left" title="لیست افرادی که در بازه زمانی مجاز برای ورود به نیروگاه قرار ندارند">
                        </div>
                        <div>
                            <img src="{{URL::to('/')}}/card001.png" id="fourth_report" class="reza2" data-toggle="tooltip" data-placement="left" title="لیست صاحبان کارت معتبر">
                        </div>
                        <div>
                            <img src="{{URL::to('/')}}/cardexpired002.png" id="fifth_report" class="reza2" data-toggle="tooltip" data-placement="left" title="لیست صاحبان کارت منقضی شده">
                        </div>
