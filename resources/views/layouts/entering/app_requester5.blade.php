        ...
        <div class="col-12">
            <div class="bg-dark" style="width: 100%;height:95px;margin-top: 3px;border-radius: 5px">
                <div class="row justify-content-center" style="height: 100px">
                    ...
                    <div class="col-1"></div>
                    <div class="col-1"></div>
                    <div class="col-5"><p style="color: white;text-align: right;margin-top: 10px;font-family: Tahoma;font-size: large;font-weight: bold">نیروگاه سیکل ترکیبی کازرون</p><p style="color: white;text-align: right;font-family: Tahoma;font-size: small;font-weight: bold">گزارش گیری از درخواستهای ورود و خروج نفرات</p></div>
                    <div class="col-1"></div>
                    <div class="col-1"></div>
                </div>
            </div>
