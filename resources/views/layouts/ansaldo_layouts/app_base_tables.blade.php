...
<div class="container-fluid" id="reza">
        ...
        <div class="col-12">
            <div  style="width: 100%;height:95px;margin-top: 3px;border-radius: 5px;">
                <div class="row justify-content-center" style="height: 100px">
                    ...
                    <div class="col-1">1</div>
                    <div class="col-1">1</div>
                    <div class="col-5"><p style="color: white;text-align: right;margin-top: 10px;font-family: Tahoma;font-size: large;font-weight: bold">نیروگاه سیکل ترکیبی کازرون</p><p style="color: white;text-align: right;font-family: Tahoma;font-size: small;font-weight: bold">ورود اطلاعات پایه نرم افزار ثبت سوابق</p></div>
                    <div class="col-1">1</div>
                    <div class="col-1">1</div>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand bg-info rounded col-12" style="height: 30px;direction: rtl;margin-top: 1px">
        <ul class="navbar-nav" >
            ...
            <li class="nav-item">
                <a class="nav-link" href="/savabegh">بازگشت</a>
            </li>
        </ul>
    </nav>
