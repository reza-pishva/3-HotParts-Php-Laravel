@extends('layouts.entering.app_entering22')
@section('content')
{{--حراست نیروگاه--}}
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#sixth_report33').click(function(event) {
                $('.mylist2').hide();
                $('.mylist3').hide();
        ...
        <div class="modal-dialog modal-md" id="editlist2" style="margin-top: 100px;margin-left: 600px">
            <div class="modal-content">
                ...
                <div class="container"  style="margin: auto;background-color:white;width: 850px ;height: 260px;overflow-y: scroll">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div id="person_div" class="col" style="height:50px">
                            <table id="person_table999" align="center" style="width: 100%;font-family: Tahoma;font-size: small;margin-top: 5px;">
                                <tr style="color: black">
                                    <td class="person" style="width: 5%">کد</td>
                                    <td class="person" style="width: 10%">نام</td>
                                    <td class="person" style="width: 14%">نام خانوادگی</td>
                    ...
                    <div id="first44" class="row" style="text-align: right">
                        ...
                        <div id="sixth_report33"style="margin-left: 5px">
                            <img  src="{{URL::to('/')}}/dailyenter003.png"  class="reza2" data-toggle="tooltip" data-placement="left" title="ورود اطلاعات ورود و خروج">
                        </div>
                        <div id="sixth_report34" style="margin-left: 15px">
                            <img  src="{{URL::to('/')}}/dailyenter005.png"  class="reza2" data-toggle="tooltip" data-placement="left" title="مشاهده وضعیت ورود و خروج این فرد">
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade mt-2" id="dailyenter" style="direction: rtl;">
        <div class="modal-dialog modal-md" id="editlist2" style="margin-top: 50px;margin-left: 400px">
            <div class="modal-content">
...
{{--                                </form>--}}
            ...
            <div class="container"  style="margin: auto;background-color:white;width: 850px ;height: 260px;overflow-y: scroll">
                ...
                <div id="first44" class="row" style="text-align: right">
                    ...
                    <div id="sixth_report35" style="margin-left: 15px">
                        <img  src="{{URL::to('/')}}/edit2.png"  class="reza2" data-toggle="tooltip" data-placement="left" title="اصلاح اطلاعات ورود و خروج این فرد">
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-md" id="editlist2" style="margin-top: 30px;margin-left: 435px">
        <div class="modal-content">
            ...
            <div class="container"  style="margin: auto;background-color: #d7d7d7;width: 550px ;height: 230px;">
                ...
                <div class="row" style="margin-top: 10px">
                    ...
                    <div id="person_div88_edit" class="col" style="height:50px">
                        ...
                        <div id="s2_edit" class="container" style="text-align: left;background-color:#17a2b8;width: 100%;border-radius: 5px;height:205px;direction: rtl;color: white;margin-top:2px;padding-top: 2px;">
                            <form method="post" encType="multipart/form-data" id="individuals_edit" action="{{route('updateindividuals.store')}}">
                                {{csrf_field()}}
                                ...
                                <div class="row" style="height: 15px">
                                    <div class="col">
                                        <div class="form-group" >
                                            <input type="text" maxlength="10" class="form-control" id="date_shamsi_enter_edit"  data-toggle="tooltip" data-placement="right" placeholder="تاریخ شروع فعالیت:" name="date_enter" style="direction: rtl;font-family: Tahoma;font-size: smaller;width: 73%" required title="تاریخ ورود یا خروج">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group" >
                                            <input type="time" maxlength="10" class="form-control" id="time_enter_edit"  data-toggle="tooltip" data-placement="right"  name="time_enter" style="direction: rtl;font-family: Tahoma;font-size: smaller;width: 73%" required title="ساعت ورود یا خروج">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-top:30px">
                                    <div class="col" style="text-align:center">
                                        <button type="submit" class="btn btn-primary" style="text-align:left;font-family: Tahoma;font-size: small;text-align: center;width:50%;height: 33px;margin-top: 10px">ثبت تغییرات</button>
                                        {{--                                            <button type="submit" class="btn btn-primary" id="btnupdate_edit" style="text-align:left;font-family: Tahoma;font-size: small;text-align: center;width:50%">ثبت تغییرات</button>--}}
                                    </div>
                                </div>
