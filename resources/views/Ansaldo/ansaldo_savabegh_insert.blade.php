...
<div class="container" style="width: 100%;height:6%;border-radius: 2px">
   @include('Ansaldo.AnsaldoRecordsComponents.component01')
   @include('Ansaldo.AnsaldoRecordsComponents.component02')
   @include('Ansaldo.AnsaldoRecordsComponents.component03')
   @include('Ansaldo.AnsaldoRecordsComponents.component04')
   @include('Ansaldo.AnsaldoRecordsComponents.component05')
   @include('Ansaldo.AnsaldoRecordsComponents.component06')
   @include('Ansaldo.AnsaldoRecordsComponents.component07')
   @include('Ansaldo.AnsaldoRecordsComponents.component08')
   @include('Ansaldo.AnsaldoRecordsComponents.component09')
   @include('Ansaldo.AnsaldoRecordsComponents.component10')
   @include('Ansaldo.AnsaldoRecordsComponents.component11')
   @include('Ansaldo.AnsaldoRecordsComponents.component12')
</div>        
@endsection
