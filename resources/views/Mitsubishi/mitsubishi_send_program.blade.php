@extends('layouts.mitsubishi_layouts.app_send_program')
@section('content')
    <script>
                                            ...
                                            success: function (response) {
                                                ...
                                                for (var i = 0; i < response.results.length; i++) {
                                                    ...
                                                    detail1 = $('<button type="button" class="btn-sm border-info detail" style="font-family: Tahoma;font-size: x-small;text-align: center;width: 100%" data-toggle="modal" data-target="#savabegh">قطعات</button>').on('click', function (event) {
                                                        ...
                                                        var _token = $("input[name='_token']").val();
                                                        $.ajax({
                                                            url: '/m-get-history-bazsazi-prog/' + id_t,
                                                            method: 'GET',
                                                            success: function (response) {
                                                                var ID_S = ''
                                                                var ID_T = ''
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div style="width: 100%;height: 65%;border-radius: 3px;margin-top: 4px;padding-top: 5px;background-color: #4a5d74">
                        <p style="font-family: Tahoma;font-size: smaller;color: #fdfdfe">(Mitsubishi) برنامه ارسال و دریافت قطعات برای بازسازی</p>
                    </div>
                </div>
            </div>
        </div>
                   ...
                   <div class="row">
                       ...
                       <div class="col-2" style="background-color:rgba(72,103,121,0.5);border-radius: 3px;margin-top: 32px">
                           ...
                           {{--<div class="row" style="height: 25%">--}}
                               {{--<div class="col" >--}}
                                   {{--<a href="/m-tapr-form" > <img src="equip.png" id="add_send2" class="reza2" data-toggle="tooltip" data-placement="bottom" title="تعیین لیست قطعات" style="border-radius: 15px ;margin-top: 4px"></a>--}}
                               {{--</div>--}}
                           {{--</div>--}}
                           <div class="row" style="height: 25%">
                               <div class="col" >
                                   <a href="/m-tapr-form" > <img src="repair2.png" id="add_send2" class="reza2" data-toggle="tooltip" data-placement="bottom" title="افزودن برنامه تعمیرات" style="border-radius: 15px ;margin-top: 4px"></a>
                               </div>
                           </div>
        ...
        <div class="modal-dialog modal-md" style="margin-top: 25px">
            <div class="modal-content">
                ...
                <div class="container"  style="margin: auto;background-color:lightgray;height: 225px ">
                    <form method="post" encType="multipart/form-data" id="tpr_edit" action="{{route('tpr.edit')}}">
                        {{csrf_field()}}
                        <div class="row">
                            <div>
