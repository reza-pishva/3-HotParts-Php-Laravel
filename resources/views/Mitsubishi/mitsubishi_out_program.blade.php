@extends('layouts.mitsubishi_layouts.app_out_program')
@section('content')
    <script>
                            ...
                            success: function (response) {
                                ...
                                for (var i = 0; i < response.results.length; i++) {
                                    ...
                                    edit1 = $('<button type="button" class="btn-sm border-success edit_send" style="font-family: Tahoma;font-size: x-small;text-align: center;width: 100%;border-radius: 6px" data-toggle="modal" data-target="#myModal3">ویرایش</button>').on('click',function () {
                                        ...
                                        $('#LOCATION_NAME_EDIT').val($(this).closest('tr').find('td:eq(4)').text())
                                        $('#GROUP_COUNT_EDIT').val($(this).closest('tr').find('td:eq(6)').text())
                                        $('#DISCRIPTION_EDIT').val($(this).closest('tr').find('td:eq(5)').text())
                                        $('#DATE_SHAMSI_EDIT').val($(this).closest('tr').find('td:eq(3)').text())
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (response) {
                                                        ...
                                                        if(response.perm==1){
                                                            ...
                                                            toastr.error('برنامه ورود و خروج حذف گردید');
                                                            $('#' + (Number(id_t) + 2000).toString()).closest('tr').remove();
                                    ...
                                    detail1 = $('<td><button type="button" class="btn-sm border-info detail" style="font-family: Tahoma;font-size: x-small;text-align: center;width: 100%" data-toggle="modal" data-target="#savabegh">قطعات</button></td>').on('click', function (event) {
                                        ...
                                        var _token = $("input[name='_token']").val();
                                        $.ajax({
                                            url:'/m-get-history-out-prog/' + id_t,
                                            method: 'GET',
                                            success: function (response) {
                                                var ID_S = ''
                                                var ID_T = ''
                                                ...
                                                var TYPE_INSTAL = ''
                                                var row = ''
                                                var th = $('<tr class="bg-primary" style="color: white;font-size:x-small;text-align: center"><td>شماره سریال</td><td>کدقطعات</td><td style="text-align: center">کارکرد</td><td style="text-align: right">میزان خرابی</td><td style="text-align: right">وضعیت نصب</td><td style="text-align: right">توضیحات</td></tr>')
                                                var ID_S = ''
                                                var ID_T = ''
                                                var TIME_WORK = ''
                                                var GHATAAT_NAME=''
                                    ...
                                    if(response.results[i]['OUT_IN']==1){
                                        OUT_IN2 = $('<td hidden style="width: 8%;text-align: center;border-right:1px dotted black;font-family: Tahoma;font-size: 10px">1</td>')
                                        OUT_IN = $('<td style="width: 8%;text-align: center;border-right:1px dotted black;font-family: Tahoma;font-size: 10px">ورود</td>')
                                    }
                                    if(response.results[i]['OUT_IN']==2){
                                        OUT_IN2 = $('<td hidden style="width: 8%;text-align: center;border-right:1px dotted black;font-family: Tahoma;font-size: 10px">2</td>')
                                        OUT_IN = $('<td style="width: 8%;text-align: center;border-right:1px dotted black;font-family: Tahoma;font-size: 10px">خروج</td>')
                                    }
                                    LOCATION_NAME = $('<td style="width: 25%;text-align: center;border-right:1px dotted black;font-family: Tahoma;font-size: 10px">' + response.results[i]['LOCATION_NAME'] + '</td>')
                                    ...
                                    row.append(t4,ID_T,ID_TG,DATE_SHAMSI,LOCATION_NAME,DISCRIPTION,GROUP_COUNT,ID_TG2,OUT_IN,OUT_IN2,t1, t2,t3)
                                    $("#table1").append(row)
                                }
                            }
                        })
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div style="width: 100%;height: 65%;border-radius: 3px;margin-top: 4px;padding-top: 5px;background-color: #4a5d74">
                        <p style="font-family: Tahoma;font-size: smaller;color: #fdfdfe">(MITSUBISHI) برنامه ورود و خروج قطعات از نیروگاه</p>
                    </div>
                </div>
            </div>
        </div>
           ...
           <div class="row">
               <div class="col-3" style="height:300px">
                   ...
                   <div style="width: 95%;height: 265px;margin: auto;margin-top:3px;border-radius: 3px;background-color:rgba(105,105,105,0.5)">
                       <form method="post" encType="multipart/form-data" id="tpsrep_form" action={{route('tps.store')}}>
                           {{csrf_field()}}
                           ...
                           <div class="row mt-2"  style="text-align: center">
                               <div class="col">
                                   <select class="form-control isclicked1"  name="OUT_IN_R" id="OUT_IN_R" style="width: 200px;font-family: Tahoma;font-size: small;display: inline">
                   ...
                   <div class="row">
                       ...
                       <div class="col-2" style="background-color:rgba(105,105,105,0.5);border-radius: 3px;margin-top: 32px">
                           ...
                           <div class="row" style="height: 25%;margin-top: -5px">
                               <div class="col" >
                                   <a href="/m-bazsaz-form" > <img src="base.png" id="add_send2" class="reza2" data-toggle="tooltip" data-placement="bottom" title="افزودن اطلاعات پایه" style="border-radius: 15px ;margin-top: 4px"></a>
                               </div>
                           </div>
                       </div>
                ...
                <form method="post" encType="multipart/form-data" id="out_form" action="{{route('out.store')}}">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6" style="margin-right: 50px">
                            <input type="text" maxlength="50"  class="form-control" id="LOCATION_NAME"  data-toggle="tooltip" data-placement="right"  name="LOCATION_NAME" placeholder="محل ارسال" style="font-family: Tahoma;font-size: smaller;width: 100%;" required title="محل ارسال">
                        </div>
                    </div>
                    <br>
                    <div class="row mt-0">
                    ...
                    <form method="post" encType="multipart/form-data" id="tps_edit" action="{{route('out.edit')}}">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-5" style="margin-right: 50px">
                                <input type="text" maxlength="50"  class="form-control" id="LOCATION_NAME_EDIT"  data-toggle="tooltip" data-placement="right"  name="LOCATION_NAME_EDIT" placeholder="محل ارسال" style="font-family: Tahoma;font-size: smaller;width: 100%;" required title="محل ارسال">
                            </div>
