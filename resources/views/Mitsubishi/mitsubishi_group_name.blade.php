@extends('layouts.mitsubishi_layouts.app_group_name')
@section('content')
    <script>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div style="width: 100%;height: 65%;border-radius: 3px;margin-top: 4px;padding-top: 5px;background-color: #005299">
                        <p style="font-family: Tahoma;font-size: smaller;color: #fdfdfe"> (Mitsubishi) تعریف گروه و تخصیص قطعات</p>
                    </div>
                </div>
            </div>
        </div>
