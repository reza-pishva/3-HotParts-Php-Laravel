@extends('layouts.mitsubishi_layouts.app_savabegh_insert')
@section('content')
<script>
    ...
    $(document).ready(function() {
        ...
        $("#search_ide_btn").on('click',function(event){
          event.preventDefault();  
          var serial_no_search=$("#serial_no_search").val();
        //   alert(serial_no_search);  
          ...
          $.ajaxSetup({
            ...
            $.ajax({
                ...
                success: function (response) {
                    $("#group_name").text(response.group_code);
                    $("#first_spinner").hide();
                    $("#table2").show();
        ...
        $("#final_insert").on('click',function (event) {
            ...
            if(mizan_kharabi>0 & vaz_nasb>0 & karkard>=0 & description.length<400){
                ...
                var _token = $("input[name='_token']").val();
                $.ajax({
                    url: '/m-savabegh-insert/' + type_sabegheh +'/'+ mizan_kharabi+'/'+ vaz_nasb+'/'+ karkard+'/'+ description+'/'+ id_t1+'/'+id_sub1+'/'+id_g_global+'/'+insert_type+'/'+ghataat4+'/'+radif1+'/'+radif2+'/'+program+'/'+id_t_bazsazi1+'/'+id_t_bazsazi2,
                    method: 'GET',
                    beforeSend: function(){
                        $("#third_spinner").show();
                        $("#table_view").hide();
        ...
        $("#final_edit").on('click',function (event){   
            ...
            var _token = $("input[name='_token']").val();
            $.ajax({
                url: '/m-savabegh-update/' + sav_type +'/'+ mizan_kharabi+'/'+ vaz_nasb+'/'+ karkard+'/'+ description+'/'+insert_type+'/'+id_s+'/'+id_g_global+'/'+id_sub+'/'+id_t1+'/'+id_e+'/'+id_t_prev+'/'+radif1+'/'+radif2,
                method: 'GET' ,
                beforeSend: function(){
                    $("#forth_spinner").show();
                    $("#edit_div").hide();
        ...
        $("#final_delete").on('click',function (event){
            ...
            var _token = $("input[name='_token']").val();
            $.ajax({
                url: '/m-savabegh-delete/' + sav_type +'/'+ mizan_kharabi+'/'+ vaz_nasb+'/'+ karkard+'/'+ description+'/'+id_t1+'/'+id_sub+'/'+id_g_global+'/'+insert_type+'/'+id_s+'/'+id_t2+'/'+id_t3+'/'+ghataat4+'/'+radif1+'/'+radif2+'/'+id_t_bazsazi1+'/'+id_t_bazsazi2+'/'+radif3,
                method: 'GET' ,
                beforeSend: function(){
                    $("#forth_spinner").show();
                    $("#delete_div").hide();
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div style="width: 100%;height: 30px;border-radius: 3px;margin-top: 5px;padding-top: 4px;background-color: #22a390">
                                <p style="font-family: Tahoma;font-size: smaller;color: #fdfdfe;margin-top:2px;direction: ltr"> (Mitsubishi) جستجو در بخش سوابق قطعات</p>
                            </div>
                        </div>
                        <div class="col-2"></div>
                        <div class="col"></div>
                        ...
                        <div class="col"></div>
                        <div class="col">
                            <a href="/m-savabegh"><p style="font-family: Tahoma;font-size: x-small;margin-top:8px;color: white">بازگشت</p></a>
                        </div>
                    </div>
                    ...
                    <div class="row" style="direction: rtl">
                                    ...
                                    <table id="first_table" style="font-size: small;direction: rtl;background-color: #fdfdfe;width: 100%">
                                        ...
                                        @foreach($requests as $request)
                                            <tr style="color:black;text-align: center;font-size: 10px;font-family: Tahoma;height:20px" class="table1">
                                                ...
                                                <td style=";border-right:1px dotted black">{{\App\Mitsubishi_type_ghataat::where('ID_TG',$request['ID_TG'])->first()->GHATAAT_NAME}}</td>
                                            </tr>
                                        @endforeach
                        ...
                        <div class="col-1" style="height: 370px;width: 110%;">
                            {{-- <div style="width:130%;height:45px;background-color: #117a8b;margin-top:3px;border-radius: 3px;padding-top: 5px;margin-right: -25px">
                                <p style="color: #fdfdfe;font-family: Tahoma;font-size:small;margin-top:8px">گروه قطعه انتخابی</p>
                            </div>
                            <div style="background-color:rgba(105,105,105,0.5);height:80%;margin-top:-15px;width: 120%;border-radius: 10px;margin-right: -18px;display:none">
