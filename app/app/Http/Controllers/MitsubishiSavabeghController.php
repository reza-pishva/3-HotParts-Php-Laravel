...
class MitsubishiSavabeghController extends Controller
{
    /**
                                ...
                                foreach ($groupusers as $groupuser) {
                                    ...
                                    foreach ($grouproles as $grouprole) {
                                        ...
                                        if($role_name['role'] ==="admin" or $role_name['role'] ==="track_savabegh_insert"){
                                            ...
                                            $anns=Mitsubishi_nirogah_name::all();
                                            $tgs=Mitsubishi_type_ghataat::all();
                                            $auns=Mitsubishi_unit_number::all();
                                            $atts=Mitsubishi_tamirat_type::all();
                                            $ats=Mitsubishi_tamirkaran::all();
                                            $bas=Mitsubishi_bazsaz::all();
                                            $requests = Mitsubishi_group_name::all();
                                            $ghataats =Mitsubishi_type_ghataat::all();
                                            $sazs = DB::table('mitsubishi_sazandehs')->where('ID_S','>',0)->get()->toArray();
                                            return view('Mitsubishi.Mitsubishi_savabegh_insert',compact('requests','ghataats','sazs','anns','auns','atts','ats','bas','tgs','sellers'));
                                        }
                                ...
                                foreach ($groupusers as $groupuser) {
                                    ...
                                    foreach ($grouproles as $grouprole) {
                                        ...
                                        if($role_name['role'] ==="admin" or $role_name['role'] ==="track_savabegh_insert"){
                                            ...
                                            $ghataats =Mitsubishi_type_ghataat::all();
                                            $sazs = DB::table('mitsubishi_sazandehs')->where('ID_S','>',0)->get()->toArray();
                                            return view('Mitsubishi.mitsubishi_savabegh_search_by_ide',compact('requests','ghataats','sazs','anns','auns','atts','ats','bas','tgs','sellers'));
                                        }
    ...
    public function total()
    {
        ...
        $data = DB::table('mitsubishi_group_names')->where('ID_G','>',0)->get()->toArray();
    ...
    public function total2($id)
    {
        $ID_TGS = DB::table('mitsubishi_type_ghataats')->where('ID_TG','>',0)->get()->toArray();
        $data3 = DB::table('users')->where('id','>',0)->get()->toArray();
        $data = DB::table('mitsubishi_ghataats')->where('ID_G',$id)->orderBy('ID_E', 'DESC')->get()->toArray();
        return response()->json(['results'=> $data,'ID_TGS'=>$ID_TGS,'ID_USERS'=>$data3]);//,'ID_USERS'=>$ID_USERS
    }
    ...
    {
        $tamir_prog = Mitsubishi_tamirat_program::all();
        $bazsazi_prog1 = Mitsubishi_send_bazsazi_ghataat::all();
        $bazsazi_prog2 = Mitsubishi_resv_bazsazi_ghataat::all();
        $anbar_prog1 = Mitsubishi_store_program_in::all();
        $anbar_prog2 = Mitsubishi_store_program_out::all();
        $buy_prog1 = Mitsubishi_buy_ghataat::all();
        $eex_prog1=Mitsubishi_out_ghataat::all();

        $id_bas = Mitsubishi_bazsaz::all();
        $id_tts = Mitsubishi_tamirat_type::all();
        $id_tas = Mitsubishi_tamirkaran::all();
        $id_un = Mitsubishi_unit_number::all();
        $id_se = Mitsubishi_seller::all();
        $data = DB::table('mitsubishi_savabeghs')->where('ID_E',$id)->get()->toArray();
    ...
    public function delete($id){
            Mitsubishi_savabegh::where('ID_S', $id)->delete();
    ...
    public function savabegh_insert($type_sabegheh,$mizan_kharabi,$vaz_nasb,$karkard,$description,$id_t1,$id_sub,$id_g_global,$insert_type,$ghataat4,$radif1,$radif2,$program,$id_t_bazsazi1,$id_t_bazsazi2){
        ...
        if($program>=1){
            if($insert_type==1){
                ...
                $n= Mitsubishi_savabegh::where('ID_E',$ghataat4)->where('ID_T',$id_t1)->get()->count();
                if($n){
                    if($n>0){
                        return response()->json(['success'=>'hi','reapeted_no'=>$ghataat4,'insert_type'=>1]);
                    }
                }
                DB::table('mitsubishi_savabeghs')->insert([
                    'ID_E' => $ghataat4,
                    'ID_T' => $id_t1,
                    'ID_SUB' => $id_sub,
                    'TIME_WORK' => $karkard,
            ...
            if($insert_type==2){
                $ghataat_count=0;
                $ghataats= Mitsubishi_ghataat::where('ID_G',$id_g_global)->get()->toArray();
                foreach($ghataats as $ghataat){
                    $n= Mitsubishi_savabegh::where('ID_E',$ghataat['ID_E'])->where('ID_T',$id_t1)->get()->count();
                    if($n){
                        if($n>0){
            ...
            if($insert_type==3){
                $ghataat_count=0;
                $ghataats= Mitsubishi_ghataat::where('ID_G',$id_g_global)->orderBy('ID_E', 'DESC')->get()->toArray();
                foreach($ghataats as $ghataat){
                    $ghataat_count++;
        ...
        //     if($insert_type==1){
        //         if($id_t_bazsazi2==0){
        //             $n= Mitsubishi_savabegh::where('ID_E',$ghataat4)->where('ID_T',$id_t_bazsazi1)->get()->count();
        //             if($n){
        //                 if($n>0){
        //                     return response()->json(['success'=>'hi','reapeted_no'=>$ghataat4,'insert_type'=>1]);
        //                 }
        ...
        //         if($id_t_bazsazi2==0){
        //             foreach($ghataats as $ghataat){
        //                 $n= Mitsubishi_savabegh::where('ID_E',$ghataat['ID_E'])->where('ID_T',$id_t_bazsazi1)->get()->count();
        //                 if($n){
        //                     if($n>0){
        //                         return response()->json(['success'=>'hi','reapeted_no'=>$ghataat['ID_E'],'insert_type'=>2]);
        //                     }
    ...
    public function savabegh_update($sav_type,$mizan_kharabi,$vaz_nasb,$karkard,$description,$insert_type,$id_s,$id_g_global,$id_sub,$id_t1,$id_e,$id_t_prev,$radif1,$radif2){
        ...
        if($insert_type==1){
            $affected = DB::table('mitsubishi_savabeghs')->where('ID_S',$id_s)->update(array('TIME_WORK' => $karkard,'DAMAGE_PERCENT' => $mizan_kharabi,'TYPE_INSTAL' => $vaz_nasb,'DISCRIPTION'=>$description,'ID_T'=>$id_t1,'ID_SUB'=>$id_sub,'SAV_TYPE'=>$sav_type));
            return response()->json(['success'=>'hi']);
        }
        if($insert_type==2){
               foreach($ghataats as $ghataat){
                   $affected = DB::table('mitsubishi_savabeghs')->where('ID_E',$ghataat['ID_E'])->where('ID_T',$id_t_prev)->update(array('TIME_WORK' => $karkard,'DAMAGE_PERCENT' => $mizan_kharabi,'TYPE_INSTAL' => $vaz_nasb,'DISCRIPTION'=>$description,'ID_T'=>$id_t1,'ID_SUB'=>$id_sub,'SAV_TYPE'=>$sav_type));
               }
    ...
    public function savabegh_delete($sav_type,$mizan_kharabi,$vaz_nasb,$karkard,$description,$id_t1,$id_sub,$id_g_global,$insert_type,$id_s,$id_t2,$id_t3,$ghataat4,$radif1,$radif2,$id_t_bazsazi1,$id_t_bazsazi2,$radif3){
        $ghataat_count=0;        
        if($insert_type==1){
            Mitsubishi_savabegh::where('ID_S',$id_s)->delete();
            return response()->json(['success'=>'hi']);
        ...
        if($insert_type==2){
            Mitsubishi_savabegh::where('ID_T',$id_t1)->delete();
            return response()->json(['success'=>'hi']);
           // return response()->json(['success'=>'hi','type_sabegheh'=>$sav_type,'mizan_kharabi'=>$mizan_kharabi,'vaz_nasb'=>$vaz_nasb,'karkard'=>$karkard,'description'=>$description,'id_t1'=>$id_t1,'id_t2'=>$id_t2,'id_g_global'=>$id_g_global,'id_sub'=>$id_sub,'insert_type'=>$insert_type,'id_s'=>$id_s,'sav_type'=>$sav_type,'id_t_bazsazi1'=>$id_t_bazsazi1,'id_t_bazsazi2'=>$id_t_bazsazi2,'ghataat'=>$ghataats,'n'=>$n]);
        }
        if($insert_type==3){
                $ghataat_count=0;
                $ghataats= Mitsubishi_ghataat::where('ID_G',$id_g_global)->orderBy('ID_E', 'ASC')->get()->toArray();
                foreach($ghataats as $ghataat){
                    $ghataat_count++;
                    if($ghataat_count>=$radif1 && $ghataat_count<=$radif2){
                        Mitsubishi_savabegh::where('ID_E',$ghataat['ID_E'])->where('ID_T',$id_t1)->delete();
                    }
                }
    ...
    public function inserted_rows($id)
    {
        ...
        $id_tas = Mitsubishi_tamirkaran::all();
        $id_un = Mitsubishi_unit_number::all();
        $bazsazi1 = Mitsubishi_send_bazsazi_ghataat::all();
        $bazsazi2 = Mitsubishi_resv_bazsazi_ghataat::all();
        $anbar1 = Mitsubishi_store_program_in::all();
        $anbar2 = Mitsubishi_store_program_out::all();
        $kharid = Mitsubishi_buy_ghataat::all();
        $data = DB::table('mitsubishi_savabeghs')->where('ID_S','>',$id)->get()->toArray();
