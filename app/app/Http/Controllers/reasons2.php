...
class reasons2 extends Controller
{
    public function store(Request $request)
    {
        ...
        Request_level::where('id_exit', $id_exit)->update(['level'=>-2]);
        //level->-2
        Exit_goods_permission::where('id_exit', $id_exit)->update(['level'=>-2]);
        //open page
        //$goodstypes=Goodstype::all();
        //$requests=Exit_goods_permission::where('id_request_part',$id_request_part)->where('level',2)->get();
