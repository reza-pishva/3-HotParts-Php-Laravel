...
class second_reciever_no extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'second:reciever_no';
            ...
            foreach ($id_users as $id_user){
                ...
                if(true){
                    ...
                    else
                    {
                        ...
                        $values = array('date_shamsi_sms' => $date_shamsi,'id_user' => $id_user['id_user'],'description' => 'به نرم افزار مدیریت دریافت مجوز ورود و خروج بخش عدم تایید مدیر نیروگاه مراجعه شود','mobile' => $target[0]->mobile);
