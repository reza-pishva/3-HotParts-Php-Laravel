...
class first_reciever_no extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'first:reciever_no';
            ...
            foreach ($id_users as $id_user){
                ...
                if($id_request_part_target==$id_request_part){
                    ...
                    else
                    {
                        ...
                        $values = array('date_shamsi_sms' => $date_shamsi,'id_user' => $id_user['id_user'],'description' => 'به نرم افزار مدیریت دریافت مجوز ورود و خروج بخش عدم تایید برای مسئول مستقیم مراجعه شود','mobile' => $target[0]->mobile);
